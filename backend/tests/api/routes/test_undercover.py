...
def test_word_create_word_success(test_app: FastAPI, client: TestClient):
...
def test_word_create_word_validation_error(test_app: FastAPI, client: TestClient):
...
def test_word_get_all_words_success(test_app: FastAPI, client: TestClient):
...
def test_word_get_all_words_empty(test_app: FastAPI, client: TestClient):
...
def test_word_get_word_by_id_success(test_app: FastAPI, client: TestClient):
...
def test_word_get_word_by_id_not_found(test_app: FastAPI, client: TestClient):
...
def test_word_get_word_by_word_success(test_app: FastAPI, client: TestClient):
...
def test_word_get_word_by_word_not_found(test_app: FastAPI, client: TestClient):
...
def test_word_delete_word_success(test_app: FastAPI, client: TestClient):
...
def test_word_delete_word_not_found(test_app: FastAPI, client: TestClient):
...
# ──────────────────────────────────────────────────────────────
# Term Pairs (/api/v1/undercover/termpair)
# ──────────────────────────────────────────────────────────────


def test_term_pair_create_term_pair_success(test_app: FastAPI, client: TestClient):
...
def test_term_pair_get_all_term_pairs_success(test_app: FastAPI, client: TestClient):
...
def test_term_pair_get_all_term_pairs_empty(test_app: FastAPI, client: TestClient):
...
def test_term_pair_get_term_pair_by_id_success(test_app: FastAPI, client: TestClient):
...
def test_term_pair_get_term_pair_by_id_not_found(test_app: FastAPI, client: TestClient):
...
def test_term_pair_get_random_term_pair_success(test_app: FastAPI, client: TestClient):
...
def test_term_pair_get_random_term_pair_not_found(test_app: FastAPI, client: TestClient):
...
def test_term_pair_delete_term_pair_success(test_app: FastAPI, client: TestClient):
