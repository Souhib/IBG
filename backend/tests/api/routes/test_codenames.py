...
def test_word_pack_create_word_pack_success(test_app: FastAPI, client: TestClient):
...
def test_word_pack_create_word_pack_validation_error(test_app: FastAPI, client: TestClient):
...
def test_word_pack_get_word_packs_success(test_app: FastAPI, client: TestClient):
...
def test_word_pack_get_word_packs_empty(test_app: FastAPI, client: TestClient):
...
def test_word_pack_get_word_pack_by_id_success(test_app: FastAPI, client: TestClient):
...
def test_word_pack_get_word_pack_not_found(test_app: FastAPI, client: TestClient):
...
def test_word_pack_delete_word_pack_success(test_app: FastAPI, client: TestClient):
...
def test_word_pack_delete_word_pack_not_found(test_app: FastAPI, client: TestClient):
...
# ──────────────────────────────────────────────────────────────
# Words (/api/v1/codenames word endpoints)
# ──────────────────────────────────────────────────────────────


def test_word_add_word_to_pack_success(test_app: FastAPI, client: TestClient):
...
def test_word_get_words_by_pack_success(test_app: FastAPI, client: TestClient):
...
def test_word_get_words_by_pack_empty(test_app: FastAPI, client: TestClient):
